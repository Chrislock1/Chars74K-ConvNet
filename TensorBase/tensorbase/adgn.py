...
from .stoch import GaussianLayerConv, MultinomialLayerFC, BernoulliLayerFC
...
class AuxDeepGenMod:
    ...
    def q_a_x(self):
        with tf.variable_scope('q_a_x'):
            ...
            qa_l = GaussianLayerConv(q_a_x_l.get_output(), num_latent=100, eq_samples=10)
        ...
        with tf.variable_scope('q_a_x', reuse=True):
            ...
            qa_u = GaussianLayerConv(q_a_x_u.get_output(), num_latent=100, eq_samples=10)
    ...
    def q_y_ax(self):
        with tf.variable_scope('q_y_ax'):
            ...
            qy_l = MultinomialLayerFC(q_y_ax_l.get_output(), num_latent=100, eq_samples=10)
        ...
        with tf.variable_scope('q_y_ax', reuse=True):
            ...
            qy_u = MultinomialLayerFC(q_y_ax_u.get_output(), num_latent=100, eq_samples=10)
    ...
    def q_z_xay(self):
        with tf.variable_scope('q_z_xay'):
            ...
            qz_l = GaussianLayerConv(q_z_xay_l.get_output(), num_latent=100, eq_samples=10)
        ...
        with tf.variable_scope('q_z_xay', reuse=True):
            ...
            qz_u = GaussianLayerConv(q_z_xay_u.get_output(), num_latent=100, eq_samples=10)
    ...
    def p_a_zy(self):
        with tf.variable_scope('p_a_zy'):
            ...
            pa_l = GaussianLayerConv(p_a_zy.get_output(), num_latent=100, eq_samples=10)
        ...
        with tf.variable_scope('p_a_zy', reuse=True):
            ...
            pa_u = GaussianLayerConv(p_a_zy.get_output(), num_latent=100, eq_samples=10)
    ...
    def p_x_azy(self):
        with tf.variable_scope('p_x_azy'):
            ...
            px_l = BernoulliLayerFC(p_x_azy_l.get_output(), num_latent=784, eq_samples=10)
        ...
        with tf.variable_scope('p_x_azy'):
            ...
            px_u = BernoulliLayerFC(p_x_azy_u.get_output(), num_latent=784, eq_samples=10)
